/*
  ...
  You will need to:
    ...
    Note the Write API Key and copy&paste it into myDeviceId below
...
String myDeviceId = "PFIOEXW1VF21T7O6"; // Change this to your API key
String jsonPayload = "{\"did\":\"abcdef123\",\"t\":\"1638977830111\",\"d\":{\"temp\":\"72.2\",\"hum\":\"34.7\",\"pm_10\":\"27.8\",\"pm_o\":\"12.1\"}}";
String serverName = "sqs.us-west-2.amazonaws.com"; // Domain Name for HTTP POST / GET
...
void setup()
{
  ...
  Serial.println(F("SARA-R5 Example HTTP Get"));
...
//---
  ...
  String httpRequestData = "Action=SendMessage&Version=2012-11-05&MessageGroupId=test&MessageBody=" + jsonPayload;

  Serial.println(F("POSTing a to AWS:  "));
  Serial.println(jsonPayload);
        
  // Send HTTP POST request to /update. The reponse will be written to post_response.txt in the SARA's file system
  mySARA.sendHTTPPOSTdata(0, "/363966575565/blip-production.fifo", "post_response.txt", httpRequestData, SARA_R5_HTTP_CONTENT_APPLICATION_X_WWW);

//---

//  // Send data using HTTP GET
//  String path = "/update?api_key=" + myDeviceId + "&field1=" + String(temperature);
//
